...
import static net.sourceforge.mochadoom.data.Defines.SAVESTRINGSIZE;
import static net.sourceforge.mochadoom.data.dstrings.NUM_QUITMESSAGES;
import static net.sourceforge.mochadoom.data.dstrings.SAVEGAMENAME;
import static net.sourceforge.mochadoom.data.dstrings.endmsg;
import static net.sourceforge.mochadoom.doom.English.DOSY;
import static net.sourceforge.mochadoom.doom.English.EMPTYSTRING;
import static net.sourceforge.mochadoom.doom.English.ENDGAME;
import static net.sourceforge.mochadoom.doom.English.LOADNET;
import static net.sourceforge.mochadoom.doom.English.MSGOFF;
import static net.sourceforge.mochadoom.doom.English.MSGON;
import static net.sourceforge.mochadoom.doom.English.NETEND;
import static net.sourceforge.mochadoom.doom.English.NEWGAME;
import static net.sourceforge.mochadoom.doom.English.NIGHTMARE;
import static net.sourceforge.mochadoom.doom.English.QLOADNET;
import static net.sourceforge.mochadoom.doom.English.QLPROMPT;
import static net.sourceforge.mochadoom.doom.English.QSAVESPOT;
import static net.sourceforge.mochadoom.doom.English.QSPROMPT;
import static net.sourceforge.mochadoom.doom.English.SAVEDEAD;
import static net.sourceforge.mochadoom.doom.English.SWSTRING;
import static net.sourceforge.mochadoom.game.Keys.KEY_BACKSPACE;
import static net.sourceforge.mochadoom.game.Keys.KEY_DOWNARROW;
import static net.sourceforge.mochadoom.game.Keys.KEY_ENTER;
import static net.sourceforge.mochadoom.game.Keys.KEY_EQUALS;
import static net.sourceforge.mochadoom.game.Keys.KEY_ESCAPE;
import static net.sourceforge.mochadoom.game.Keys.KEY_F1;
import static net.sourceforge.mochadoom.game.Keys.KEY_F10;
import static net.sourceforge.mochadoom.game.Keys.KEY_F11;
import static net.sourceforge.mochadoom.game.Keys.KEY_F2;
import static net.sourceforge.mochadoom.game.Keys.KEY_F3;
import static net.sourceforge.mochadoom.game.Keys.KEY_F4;
import static net.sourceforge.mochadoom.game.Keys.KEY_F5;
import static net.sourceforge.mochadoom.game.Keys.KEY_F6;
import static net.sourceforge.mochadoom.game.Keys.KEY_F7;
import static net.sourceforge.mochadoom.game.Keys.KEY_F8;
import static net.sourceforge.mochadoom.game.Keys.KEY_F9;
...
public class Menu extends AbstractDoomMenu {
    ...
    class M_ChangeDetail
        ...
        public void invoke(int choice) {
            ...
            R.SetViewSize(screenblocks, detailLevel);
            if (detailLevel == 0) DM.players[DM.consoleplayer].message = English.DETAILHI;
            else DM.players[DM.consoleplayer].message = English.DETAILLO;
