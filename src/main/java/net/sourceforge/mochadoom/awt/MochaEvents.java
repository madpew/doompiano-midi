...
import net.sourceforge.mochadoom.system.DoomEventInterface;
...
import static net.sourceforge.mochadoom.game.Keys.KEY_END;
...
import static net.sourceforge.mochadoom.game.Keys.KEY_HOME;
import static net.sourceforge.mochadoom.game.Keys.KEY_LEFTARROW;
import static net.sourceforge.mochadoom.game.Keys.KEY_NUMLOCK;
import static net.sourceforge.mochadoom.game.Keys.KEY_PAUSE;
import static net.sourceforge.mochadoom.game.Keys.KEY_PGDN;
import static net.sourceforge.mochadoom.game.Keys.KEY_PGUP;
import static net.sourceforge.mochadoom.game.Keys.KEY_RIGHTARROW;
import static net.sourceforge.mochadoom.game.Keys.KEY_SCROLLLOCK;
import static net.sourceforge.mochadoom.game.Keys.KEY_SHIFT;
import static net.sourceforge.mochadoom.game.Keys.KEY_TAB;
